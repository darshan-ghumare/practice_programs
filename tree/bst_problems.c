...
int bst_cal_height(node_t *cur_root)
{
    ...
    return 1 + (left_sub_tree_length > right_sub_tree_length)? left_sub_tree_length: right_sub_tree_length;
}
...
void bst_print_inorder_nonrecur_1stack(node_t *cur_root)
{
    ...
    while (!done)
    {
        ...
        else                                                             
        {
            ...
            {
                current = (node_t *) stack_pop(&nodes_stack);
...
*/
    ...
    while (!queue_empty(&visited_nodes))
    {
        ...
        if (visited_node_count == cur_level_total_nodes)
        {
            ...
            {
                node = (node_t *) queue_remove(&visited_nodes);
